 ...
 * Reorder Presentationは同じ物理DnD境界内でLifecycleと物理情報を受け取り、DnD Interactionの意味状態と組み合わせて移動対象行、有効な挿入位置、周囲行の押しのけ表示を行う。
 ...
 * Reorder Presentationも同じ物理DnD境界へ接続し、意味状態と必要な物理情報がそろった期間だけ移動対象行、有効な挿入位置、押しのけ表示を行う。
