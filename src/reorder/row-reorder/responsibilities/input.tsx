 ...
 * 結合範囲により開始できない行では物理DnDを登録せず、原因となるblocking merged cellを開始を試みた位置とともにPresentationへ通知する。
 ...
 * 開始を妨げる結合セルがある行ではDraggableを登録せず、原因セルを操作位置付近へ表示できる情報とともにPresentationへ通知する。
