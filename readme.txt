...
Yamabiko Table Reorder 0.6.1 provides Row Reorder for WordPress Core Table and Flexible Table Block.
...
Column Reorder is not included in 0.6.1 and is currently under development as the next feature.
