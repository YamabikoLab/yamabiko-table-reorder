...
workspace "YTR Reorder v1 Architecture" {
	...
	model {
		...
		DEP_011 = RESP_WORDPRESS_REORDER_APPLY_INTEGRATION -> RESP_RF_APPLY_COORDINATION "Apply状態、確認summary、確定結果、および最終位置を利用するために必要とする。" {
			tags "Structural Dependency"
		}
		...
		DEP_014 = RESP_ACCESSIBILITY_PRESENTATION -> EXT_WORDPRESS_COMPONENTS "WordPressが提供する標準操作部品のsemantic Contractを優先して利用するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_015 = RESP_ACCESSIBILITY_PRESENTATION -> EXT_BROWSER_ACCESSIBILITY "native semanticsを補足する意味、状態、関係を公開するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_016 = RESP_FOCUS_COORDINATION -> RESP_EDITOR_DOM_CONTEXT "focus targetと同じEditor表示環境を要求時点で解決するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_017 = RESP_FOCUS_COORDINATION -> EXT_WORDPRESS_EDITOR "現在のTable、toolbar、RF、確認、反映中表示、editing surfaceの存在を確認するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_018 = RESP_FOCUS_COORDINATION -> EXT_BROWSER_ACCESSIBILITY "現在targetへのfocus適用と維持に必要とする。" {
			tags "Structural Dependency"
		}
		DEP_019 = RESP_ANNOUNCEMENT_DELIVERY -> EXT_BROWSER_ACCESSIBILITY "一回性の意味通知を支援技術へ公開するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_020 = RESP_RF_INTERACTION -> RESP_RF_INPUT_INTERPRETATION "現在入力を入力問題または内部指定へ解釈するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_021 = RESP_RF_INTERACTION -> RESP_RF_ROW_RESOLUTION "Row指定を現在Tableへ解決するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_022 = RESP_RF_INTERACTION -> RESP_RF_COLUMN_RESOLUTION "Column指定を現在Tableへ解決するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_023 = RESP_RF_INTERACTION -> RESP_RF_APPLY_COORDINATION "成立候補を反映し、Apply結果と最終位置を受けるために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_024 = RESP_RF_INTERACTION -> RESP_ROW_TABLE_INTEGRATION "Row入力範囲を現在Tableから取得するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_025 = RESP_RF_INTERACTION -> RESP_COLUMN_TABLE_INTEGRATION "Column入力選択肢と列記述を現在Tableから取得するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_026 = RESP_RF_ROW_RESOLUTION -> RESP_ROW_TABLE_INTEGRATION "現在のRow構造と診断を利用するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_027 = RESP_RF_COLUMN_RESOLUTION -> RESP_COLUMN_TABLE_INTEGRATION "現在のColumn構造と診断を利用するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_028 = RESP_RF_APPLY_COORDINATION -> RESP_REORDER_APPLY_POLICY "更新対象セル数から通常反映または確認付き大規模反映を選択するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_029 = RESP_RF_APPLY_COORDINATION -> RESP_ROW_TABLE_INTEGRATION "Row候補の再照合、確定更新、および確定後位置に必要とする。" {
			tags "Structural Dependency"
		}
		DEP_030 = RESP_RF_APPLY_COORDINATION -> RESP_COLUMN_TABLE_INTEGRATION "Column候補の再照合、確定更新、および確定後位置に必要とする。" {
			tags "Structural Dependency"
		}
		DEP_031 = RESP_ROW_TABLE_INTEGRATION -> EXT_SUPPORTED_TABLE_BLOCK "現在のRow構造取得と確定行移動に必要とする。" {
			tags "Structural Dependency"
		}
		DEP_032 = RESP_ROW_TABLE_INTEGRATION -> EXT_WORDPRESS_UNDO "一回の成立した行移動を一回のUndo単位として維持するために必要とする。" {
			tags "Structural Dependency"
		}
		DEP_033 = RESP_COLUMN_TABLE_INTEGRATION -> EXT_SUPPORTED_TABLE_BLOCK "現在のColumn構造取得と確定列移動に必要とする。" {
			tags "Structural Dependency"
		}
		DEP_034 = RESP_COLUMN_TABLE_INTEGRATION -> EXT_WORDPRESS_UNDO "一回の成立した列移動を一回のUndo単位として維持するために必要とする。" {
			tags "Structural Dependency"
		}
		...
		PF_003 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_RF_INTERACTION "Keyboardまたは他の標準入力を同じRF Sessionへ接続する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_004 = RESP_RF_INTERACTION -> RESP_RF_INPUT_INTERPRETATION "現在入力を方向固有Resolution向けの内部指定へ解釈する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_005 = RESP_RF_INTERACTION -> RESP_RF_ROW_RESOLUTION "成立したRow指定を現在Tableへ解決する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_006 = RESP_RF_INTERACTION -> RESP_RF_COLUMN_RESOLUTION "成立したColumn指定を現在Tableへ解決する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_007 = RESP_RF_ROW_RESOLUTION -> RESP_ROW_TABLE_INTEGRATION "Row構造と診断を既存の方向固有権威から取得する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_008 = RESP_RF_COLUMN_RESOLUTION -> RESP_COLUMN_TABLE_INTEGRATION "Column構造と診断を既存の方向固有権威から取得する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_009 = RESP_RF_INTERACTION -> RESP_ACCESSIBILITY_PRESENTATION "現在の入力意味、評価、操作可否をaccessible Presentationへ渡す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_010 = RESP_ACCESSIBILITY_PRESENTATION -> EXT_WORDPRESS_COMPONENTS "標準UI primitiveへRF / Applyの意味と状態を接続する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_011 = RESP_ACCESSIBILITY_PRESENTATION -> EXT_BROWSER_ACCESSIBILITY "native semanticsを補足する必要な意味と関係を公開する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_012 = RESP_RF_INTERACTION -> RESP_RF_APPLY_COORDINATION "成立した候補の既存Apply Lifecycleへ進む。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_013 = RESP_RF_APPLY_COORDINATION -> RESP_WORDPRESS_REORDER_APPLY_INTEGRATION "確認、反映中、表示復帰に必要なApply状態と最終位置を公開する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_014 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_FOCUS_COORDINATION "RF openまたは明示的終了に対応するfocus intentを調停へ渡す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_015 = RESP_WORDPRESS_REORDER_APPLY_INTEGRATION -> RESP_FOCUS_COORDINATION "Apply Lifecycleに対応するfocus intentを調停へ渡す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_016 = RESP_FOCUS_COORDINATION -> EXT_BROWSER_ACCESSIBILITY "現在のEditor contextで確定したfocus targetへ移動する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_017 = RESP_RF_INTERACTION -> RESP_WORDPRESS_REORDER_INTEGRATION "新しく成立した一回性の結果意味をWordPress接続へ公開する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_018 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_ANNOUNCEMENT_DELIVERY "確定済みの一回性結果意味を通知境界へ渡す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_019 = RESP_ANNOUNCEMENT_DELIVERY -> EXT_BROWSER_ACCESSIBILITY "結果意味をfocusから独立した状態変化として公開する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_020 = EXT_BROWSER_ACCESSIBILITY -> EXT_ASSISTIVE_TECHNOLOGY "公開された操作意味、状態、focus、announcementを支援技術へ伝える。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBLE_RF_END_TO_END,normal"
		}
		PF_021 = RESP_ROW_TABLE_INTEGRATION -> RESP_RF_ROW_RESOLUTION "[failure] Row指定の構造拒否または現在Tableでの利用不能を返す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,failure"
		}
		PF_022 = RESP_COLUMN_TABLE_INTEGRATION -> RESP_RF_COLUMN_RESOLUTION "[failure] Column指定の構造拒否または現在Tableでの利用不能を返す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,failure"
		}
		PF_023 = RESP_RF_ROW_RESOLUTION -> RESP_RF_INTERACTION "[recovery] Rowのno-op、構造拒否、利用不能を現在RF評価へ戻す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_024 = RESP_RF_COLUMN_RESOLUTION -> RESP_RF_INTERACTION "[recovery] Columnのno-op、構造拒否、利用不能を現在RF評価へ戻す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_025 = RESP_ROW_TABLE_INTEGRATION -> RESP_RF_APPLY_COORDINATION "[failure] Apply時のRow再照合不成立または更新不能を返す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,failure"
		}
		PF_026 = RESP_COLUMN_TABLE_INTEGRATION -> RESP_RF_APPLY_COORDINATION "[failure] Apply時のColumn再照合不成立または更新不能を返す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,failure"
		}
		PF_027 = RESP_RF_APPLY_COORDINATION -> RESP_RF_INTERACTION "[recovery] Table未変更のfailureと現在入力の再評価へ戻す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_028 = RESP_RF_INTERACTION -> RESP_ACCESSIBILITY_PRESENTATION "[recovery] 現在の入力問題または指定全体の結果をaccessible Presentationへ渡す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_029 = RESP_RF_INTERACTION -> RESP_WORDPRESS_REORDER_INTEGRATION "[recovery] 新しく成立したblocked、no-op、またはfailure意味をWordPress接続へ公開する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_030 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_ANNOUNCEMENT_DELIVERY "[recovery] 確定済みの一回性failure / recovery意味を通知境界へ渡す。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_031 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_FOCUS_COORDINATION "[recovery] Designでfocus移動が必要なfailureまたは明示的終了だけを復帰intentへ変換する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		PF_032 = RESP_FOCUS_COORDINATION -> EXT_WORDPRESS_EDITOR "[recovery] 現在存在する修正対象または安定したEditor操作位置へfocusを復帰する。" {
			tags "Process Flow,ProcessFlow_PV_ACCESSIBILITY_FAILURE_RECOVERY,recovery"
		}
		...
		RT_046 = RESP_FOCUS_COORDINATION -> EXT_BROWSER_ACCESSIBILITY "最終targetが成立すればfocusを適用し、成立しないことが確定した場合は明示されたfallbackへ限定して適用する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.8" "最終targetが成立すればfocusを適用し、成立しないことが確定した場合は明示されたfallbackへ限定して適用する。"
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.8" "最終targetが成立すればfocusを適用し、成立しないことが確定した場合は明示されたfallbackへ限定して適用する。"
			}
		}
		RT_047 = RESP_FOCUS_COORDINATION -> RESP_WORDPRESS_REORDER_APPLY_INTEGRATION "focus適用、明示されたfallback、対象Table消失、または利用者の別位置への移動によってintentがsettleしたことを返す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.9" "focus適用、明示されたfallback、対象Table消失、または利用者の別位置への移動によってintentがsettleしたことを返す。"
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.9" "focus適用、明示されたfallback、対象Table消失、または利用者の別位置への移動によってintentがsettleしたことを返す。"
			}
		}
		RT_048 = RESP_WORDPRESS_REORDER_APPLY_INTEGRATION -> RESP_RF_APPLY_COORDINATION "focus intentのsettleを含む表示復帰完了を返す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.10" "focus intentのsettleを含む表示復帰完了を返す。"
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.10" "focus intentのsettleを含む表示復帰完了を返す。"
			}
		}
		RT_049 = RESP_RF_APPLY_COORDINATION -> RESP_RF_INTERACTION "確定済みRow Move summaryを持つsuccessを返す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.11" "確定済みRow Move summaryを持つsuccessを返す。"
			}
		}
		RT_050 = RESP_RF_INTERACTION -> RESP_WORDPRESS_REORDER_INTEGRATION "一度だけ提示可能なsuccessを提供する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.12" "一度だけ提示可能なsuccessを提供する。"
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.12" "一度だけ提示可能なsuccessを提供する。"
			}
		}
		RT_051 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_ANNOUNCEMENT_DELIVERY "確定済み移動前Row位置と確定後位置を持つsuccess通知を渡す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.13" "確定済み移動前Row位置と確定後位置を持つsuccess通知を渡す。"
			}
		}
		RT_052 = RESP_ANNOUNCEMENT_DELIVERY -> EXT_BROWSER_ACCESSIBILITY "successをfocusから独立して公開する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_SUCCESS,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_SUCCESS.step.14" "successをfocusから独立して公開する。"
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.14" "successをfocusから独立して公開する。"
			}
		}
		RT_053 = RESP_RF_APPLY_COORDINATION -> RESP_COLUMN_TABLE_INTEGRATION "Column候補の再照合と確定更新を要求する。" {
		...
		RT_054 = RESP_COLUMN_TABLE_INTEGRATION -> RESP_RF_APPLY_COORDINATION "確定更新成功と確定後Column位置を返す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.4" "確定更新成功と確定後Column位置を返す。"
			}
		}
		RT_055 = RESP_WORDPRESS_REORDER_APPLY_INTEGRATION -> RESP_FOCUS_COORDINATION "確定後Column位置に対応する結果確認targetを渡す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.7" "確定後Column位置に対応する結果確認targetを渡す。"
			}
		}
		RT_056 = RESP_RF_APPLY_COORDINATION -> RESP_RF_INTERACTION "確定済みColumn Move summaryを持つsuccessを返す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.11" "確定済みColumn Move summaryを持つsuccessを返す。"
			}
		}
		RT_057 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_ANNOUNCEMENT_DELIVERY "確定済み移動前Column位置と確定後位置を持つsuccess通知を渡す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS"
			properties {
				"runtime.RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS.step.13" "確定済み移動前Column位置と確定後位置を持つsuccess通知を渡す。"
			}
		}
		RT_058 = RESP_ROW_TABLE_INTEGRATION -> RESP_RF_APPLY_COORDINATION "Row Applyの再照合不成立または更新不能をTable未変更で返す。" {
		...
		RT_059 = RESP_RF_APPLY_COORDINATION -> RESP_WORDPRESS_REORDER_APPLY_INTEGRATION "Table未変更のediting surface restorationを要求する。" {
		...
		RT_060 = RESP_WORDPRESS_REORDER_APPLY_INTEGRATION -> EXT_WORDPRESS_EDITOR "対象Tableのediting surfaceを再成立させる。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_061 = RESP_WORDPRESS_REORDER_APPLY_INTEGRATION -> RESP_RF_APPLY_COORDINATION "表示復帰完了を返す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_062 = RESP_RF_APPLY_COORDINATION -> RESP_RF_INTERACTION "failureを返して現在Row入力の再評価へ戻す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE"
			properties {
				"runtime.RV_ACCESSIBILITY_ROW_APPLY_FAILURE.step.5" "failureを返して現在Row入力の再評価へ戻す。"
			}
		}
		RT_063 = RESP_RF_INTERACTION -> RESP_WORDPRESS_REORDER_INTEGRATION "入力を保持したRF状態、現在評価、および一度だけ提示可能なfailureを提供する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_064 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_ACCESSIBILITY_PRESENTATION "現在評価に基づく修正対象とfailure Presentationを要求する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_065 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_FOCUS_COORDINATION "現在評価と通常の操作順から定まる意味上の修正targetを渡す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_066 = RESP_FOCUS_COORDINATION -> EXT_BROWSER_ACCESSIBILITY "現在成立する修正targetへfocusを適用する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_067 = RESP_WORDPRESS_REORDER_INTEGRATION -> RESP_ANNOUNCEMENT_DELIVERY "Table未変更を含むfailure通知を渡す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_068 = RESP_ANNOUNCEMENT_DELIVERY -> EXT_BROWSER_ACCESSIBILITY "failureをfocusから独立して公開する。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_ROW_APPLY_FAILURE,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
		...
		RT_069 = RESP_COLUMN_TABLE_INTEGRATION -> RESP_RF_APPLY_COORDINATION "Column Applyの再照合不成立または更新不能をTable未変更で返す。" {
		...
		RT_070 = RESP_RF_APPLY_COORDINATION -> RESP_RF_INTERACTION "failureを返して現在Column入力の再評価へ戻す。" {
			tags "Runtime Interaction,Runtime_RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE"
			properties {
	...
	views {
		systemLandscape "DV_ACCESSIBILITY_RESPONSIBILITY" {
			...
			include EXT_WORDPRESS_EDITOR EXT_WORDPRESS_COMPONENTS EXT_BROWSER_ACCESSIBILITY EXT_ASSISTIVE_TECHNOLOGY EXT_SUPPORTED_TABLE_BLOCK EXT_WORDPRESS_UNDO RESP_REORDER_MODE RESP_REORDER_APPLY_POLICY RESP_EDITOR_DOM_CONTEXT RESP_WORDPRESS_REORDER_INTEGRATION RESP_WORDPRESS_REORDER_APPLY_INTEGRATION RESP_ACCESSIBILITY_PRESENTATION RESP_FOCUS_COORDINATION RESP_ANNOUNCEMENT_DELIVERY RESP_RF_INTERACTION RESP_RF_INPUT_INTERPRETATION RESP_RF_ROW_RESOLUTION RESP_RF_COLUMN_RESOLUTION RESP_RF_APPLY_COORDINATION RESP_ROW_TABLE_INTEGRATION RESP_COLUMN_TABLE_INTEGRATION
		...
		systemLandscape "DV_ACCESSIBILITY_MEANING" {
			...
			include EXT_SUPPORTED_TABLE_BLOCK RESP_REORDER_APPLY_POLICY RESP_RF_INTERACTION RESP_RF_INPUT_INTERPRETATION RESP_RF_ROW_RESOLUTION RESP_RF_COLUMN_RESOLUTION RESP_RF_APPLY_COORDINATION RESP_ROW_TABLE_INTEGRATION RESP_COLUMN_TABLE_INTEGRATION RESP_ACCESSIBILITY_PRESENTATION
			exclude "relationship.tag!=Structural Dependency"
			autoLayout lr
		}
		...
		custom "RV_ACCESSIBILITY_ROW_APPLY_SUCCESS" {
			...
			properties {
				"runtime.steps" "1=RT_039;2=RT_040;3=RT_041;4=RT_042;5=RT_043;6=RT_044;7=RT_045;8=RT_046;9=RT_047;10=RT_048;11=RT_049;12=RT_050;13=RT_051;14=RT_052"
			}
			autoLayout lr
		}
		...
		custom "RV_ACCESSIBILITY_COLUMN_APPLY_SUCCESS" {
			...
			properties {
				"runtime.steps" "1=RT_039;2=RT_040;3=RT_053;4=RT_054;5=RT_043;6=RT_044;7=RT_055;8=RT_046;9=RT_047;10=RT_048;11=RT_056;12=RT_050;13=RT_057;14=RT_052"
			}
			autoLayout lr
		}
		...
		custom "RV_ACCESSIBILITY_ROW_APPLY_FAILURE" {
			...
			properties {
				"runtime.steps" "1=RT_058;2=RT_059;3=RT_060;4=RT_061;5=RT_062;6=RT_063;7=RT_064;8=RT_065;9=RT_066;10=RT_067;11=RT_068"
			}
			autoLayout lr
		}
		...
		custom "RV_ACCESSIBILITY_COLUMN_APPLY_FAILURE" {
			...
			properties {
				"runtime.steps" "1=RT_069;2=RT_059;3=RT_060;4=RT_061;5=RT_070;6=RT_063;7=RT_064;8=RT_065;9=RT_066;10=RT_067;11=RT_068"
			}
			autoLayout lr
		}
