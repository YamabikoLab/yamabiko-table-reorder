...
$content = implode(
	...
	[
		...
		'<!-- wp:list {"ordered":true} --><ol class="wp-block-list"><li>Drag a regular row to a new position.</li><li>Drag a regular column to a new position.</li><li>Use Undo to restore the original order.</li><li>For row reordering, confirm that you cannot move across the vertical merge spanning rows 7-8.</li><li>For column reordering, confirm that the horizontal merge on row 14 blocks affected columns and destinations.</li></ol><!-- /wp:list -->',
