...
$content = implode(
	'',
	[
		'<!-- wp:paragraph --><p>WordPress Core Table と Flexible Table Block で、マウスまたはタッチによる行・列のドラッグ＆ドロップを試せます。Table を選択し、ツールバーの「行を並び替え」または「列を並び替え」から並び替えモードを開始してください。</p><!-- /wp:paragraph -->',
		'<!-- wp:heading --><h2 class="wp-block-heading">Row / Column チャレンジ</h2><!-- /wp:heading -->',
		'<!-- wp:list {"ordered":true} --><ol class="wp-block-list"><li>通常の行を1つドラッグして移動する</li><li>通常の列を1つドラッグして移動する</li><li>Undo で元に戻す</li><li>行並び替えでは7〜8行目の縦結合をまたぐ位置へ移動できないことを確認する</li><li>列並び替えでは14行目の横結合により移動できない列・移動先があることを確認する</li></ol><!-- /wp:list -->',
		'<!-- wp:separator --><hr class="wp-block-separator has-alpha-channel-opacity"/><!-- /wp:separator -->',
		'<!-- wp:heading --><h2 class="wp-block-heading">WordPress Core Table：日本の山30座</h2><!-- /wp:heading -->',
		'<!-- wp:paragraph --><p>基本の行・列並び替えを試すエリアです。7〜8行目の所在地は縦結合、14行目の山名＋標高は横結合です。行並び替えでは縦結合、列並び替えでは横結合による制約も確認できます。</p><!-- /wp:paragraph -->',
		$core_table,
		'<!-- wp:separator --><hr class="wp-block-separator has-alpha-channel-opacity"/><!-- /wp:separator -->',
		'<!-- wp:heading --><h2 class="wp-block-heading">Flexible Table Block：世界の山30座</h2><!-- /wp:heading -->',
		'<!-- wp:paragraph --><p>書式付きセルや結合セルを含むTableで行・列並び替えを試すエリアです。7〜8行目の所在地は縦結合、14行目の山名＋標高は横結合です。行並び替えでは縦結合、列並び替えでは横結合による制約を確認できます。RichText、リンク、インラインコード、改行、scope、class、セルスタイルも含めています。</p><!-- /wp:paragraph -->',
		$flexible_table,
